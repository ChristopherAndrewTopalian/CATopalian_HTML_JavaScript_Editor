...
function makeTitleOfApp()
{
    ...
    titleOfApplication.href = 'https://github.com/ChristopherAndrewTopalian/CATopalian_HTML_JavaScript_Editor'
    titleOfApplication.target = '_blank';
    titleOfApplication.textContent = ' CATopalian HTML JavaScript Editor';
